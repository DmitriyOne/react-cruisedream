...
import { CRUISE_GMAILS, CRUISE_PAYMENT, CRUISE_SOCIAL_LINKS } from '@crdr/constants'

import { Container, Heading, MyImage } from '@crdr/ui'

import telegramIcon from '@crdr/image/messengers/telegram.svg'
import whatsappIcon from '@crdr/image/messengers/whatsapp.svg'
			...
			>
				...
				<div className={styles.blocks}>
					...
					<div className={styles.messengersRow}>
						...
						>
							<MyImage
								componentClass={styles.messengersIcon}
								src={telegramIcon}
								alt="Telegram icon"
							/>
							Telegram
